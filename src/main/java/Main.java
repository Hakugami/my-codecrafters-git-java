...
//     Uncomment this block to pass the first stage
        ...
        switch (command) {
            ...
            case "cat-file" -> {
                ...
                try(BufferedReader reader = new BufferedReader(new InputStreamReader(new InflaterInputStream(new FileInputStream(blobFile))))) {
                    String line = reader.readLine();
                    String formatedLine = line.substring(line.indexOf("\0") + 1); 
