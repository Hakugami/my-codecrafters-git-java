...
import serializer.BlobSerializer;
import serializer.CommitSerializer;
import serializer.ObjectContentSerializer;
...
public class ObjectType<T> {
    ...
    public static ObjectType byClass(Class<?> clazz) {
        for (final var type : TYPES) {
