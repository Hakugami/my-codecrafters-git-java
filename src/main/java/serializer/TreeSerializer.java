...
import model.TreeEntryMode;
import model.TreeEntryModeType;
...
public class TreeSerializer implements ObjectContentSerializer<Tree> {
    ...
    public static void serializeEntry(TreeEntry entry,
        ...
        dataOutputStream.write(HexFormat.of().parseHex(entry.hash()));
    }
    @Override
